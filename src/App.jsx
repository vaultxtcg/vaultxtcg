        ...
        <main style={styles.main}>
          ...
          {loading ? <Skeleton styles={styles} /> : (
            <>
              ...
              {tab === "quickAddCard" && (
                <QuickAddCardView form={form} setForm={setForm} isMobile={isMobile} styles={styles} saving={saving} handleCostChange={handleCostChange} setPriceManuallyEdited={setPriceManuallyEdited} frontFile={frontFile} backFile={backFile} setFrontFile={setFrontFile} setBackFile={setBackFile} cancelEdit={cancelEdit} setTab={setTab} saveCard={saveCard} />
              )}
              {tab === "stockIn" && (
                <StockInView form={form} setForm={setForm} editingId={editingId} isMobile={isMobile} styles={styles} saving={saving} handleCostChange={handleCostChange} setPriceManuallyEdited={setPriceManuallyEdited} frontFile={frontFile} backFile={backFile} setFrontFile={setFrontFile} setBackFile={setBackFile} cancelEdit={cancelEdit} setTab={setTab} saveCard={saveCard} />
              )}
              {tab === "cart" && (
